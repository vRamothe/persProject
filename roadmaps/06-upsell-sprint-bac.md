...
| **Statut** | ⬜ À faire |
| **Priorité** | 6 |
| **Dépendances** | #03 Stripe (pour le price_id) |

---

## Description

Définir et formaliser une offre premium "Sprint Bac" combinant l'accès illimité à l'application et 1h/mois de coaching individuel en visio pour analyser les analytics de l'élève et cibler ses points faibles. Cette offre est un package business (~€89/mois) proposé sur la landing page et dans le modal paywall (#02). Pas de développement logiciel — uniquement la définition du produit et de son intégration tarifaire dans l'offre Stripe.
