# 03 — Beta Test avec Élèves Actuels
...
| **Statut** | ⬜ À faire |
| **Priorité** | 3 |
| **Dépendances** | #01 Paywall, #02 Stripe (optionnel — possible sans paiement) |

---

## Description

Créer des comptes gratuits (avec abonnement offert ou flag `beta`) pour les élèves actuels en cours particuliers. Embarquer les parents dans le processus pour récolter du feedback structuré (bugs, UX, contenu) et obtenir les premiers témoignages utilisables pour la landing page (#04).
...
- Au moins 2 témoignages exploitables pour la landing page (#04)
