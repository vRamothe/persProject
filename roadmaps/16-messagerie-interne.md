...
| **Statut** | ⬜ À faire |
| **Priorité** | 16 |
| **Dépendances** | #15 Dashboards Par Rôle |

---

## Description

Implémenter la messagerie interne entre utilisateurs liés. Les modèles `Conversation` et `Message` existent déjà (Phase 1 / #12). Ajouter les règles d'accès, les vues, les templates HTMX et les notifications de message.
