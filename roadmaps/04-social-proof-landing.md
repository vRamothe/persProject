# 04 — Social Proof sur Landing Page
...
| **Statut** | ⬜ À faire |
| **Priorité** | 4 |
| **Dépendances** | #03 Beta Test (pour les témoignages) |

---

## Description

Ajouter une section de témoignages sur la page d'accueil publique (`accueil.html`) pour établir la confiance avec les visiteurs. Les témoignages proviennent des beta testeurs (#03) et sont affichés sous forme de cards avec citation, prénom, niveau et matière préférée. Un badge de confiance "Conçu par un enseignant certifié local" est affiché en bonne place. Les témoignages sont codés en dur dans le template (pas de modèle dédié) pour cette première itération.
