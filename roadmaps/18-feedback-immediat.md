...
| **Statut** | ⬜ À faire |
| **Priorité** | 18 |
| **Dépendances** | Aucune (compatible avec #17) |

---

## Description

Mode question-par-question avec correction immédiate via HTMX. Nouveau champ `feedback_immediat` (BooleanField) sur `Quiz`. Chaque question évaluée individuellement, correction + explication affichées, score cumulé en temps réel. Incompatible avec chronomètre (#17) — si les deux actifs, chronomètre prioritaire.
