...
class CustomUserAdmin(UserAdmin):
    list_display = ["email", "prenom", "nom", "role", "niveau", "is_beta", "is_active", "date_joined"]
    list_filter = ["role", "niveau", "is_beta", "is_active"]
    ...
    fieldsets = (
        ...
        ("Permissions", {"fields": ("is_active", "is_staff", "is_beta", "is_superuser", "groups", "user_permissions")}),
